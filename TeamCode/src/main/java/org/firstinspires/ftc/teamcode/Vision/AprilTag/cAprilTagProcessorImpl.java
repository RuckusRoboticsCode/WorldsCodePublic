...
public class cAprilTagProcessorImpl extends cAprilTagProcessor
{
    private static final String TAG = "AprilTagProcessorImpl";
    ...
    public cAprilTagProcessorImpl(double fx, double fy, double cx, double cy, DistanceUnit outputUnitsLength, AngleUnit outputUnitsAngle, AprilTagLibrary tagLibrary,
    ...
    static class Pose
    {
        ...
        private Pose(Mat rvec, Mat tvec)
        {
            this.rvec = rvec;
            this.tvec = tvec;
        }
