...
public abstract class cAprilTagProcessor implements VisionProcessor
{
    ...
    public static cAprilTagProcessor easyCreateWithDefaults()
    {
        return new cAprilTagProcessor.Builder().build();
    }
