...
public class BlueLocations {
    ...
    public enum Poses {
        ...
        CYCLE_START_TRUSS(new Pose2d(20, trussY, Math.toRadians(180))),
        CYCLE_START_TRUSS_2(new Pose2d(-30, trussY, Math.toRadians(180))),
        TRUSS_STACK(new Pose2d(stackX, 35.125, Math.toRadians(180))),

        STAGE_DOOR_WAIT(new Pose2d(28, stageDoorStackY, Math.toRadians(225))),
        TRUSS_WAIT(new Pose2d(20, trussY, Math.toRadians(135))),
