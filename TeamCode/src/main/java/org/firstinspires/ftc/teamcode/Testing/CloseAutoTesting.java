...
@Config
@Autonomous
public class CloseAutoTesting extends LinearOpModeEx {

    CloseAutonomousOpMode auto;
    ...
    public static Util.Path path = Util.Path.TRUSS;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        auto = new CloseAutonomousOpMode(
                this,
                allianceColor,
                parking,
                path,
